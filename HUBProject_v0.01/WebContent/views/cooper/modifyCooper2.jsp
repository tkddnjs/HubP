            ...
            <div class="row">
              <div class="col-md-8 col-sm-12 col-xs-12 col-md-offset-2">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
					<form id="demo-form2" action="${pageContext.request.contextPath}/cooper/modify.do" data-parsley-validate class="form-horizontal form-label-left" method="post">
                      <div class="form-group">
                        <label class="control-label col-md-2 col-sm-3 col-xs-12" for="coName">Cooper Name <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-8">
                          <input type="text" id="coName" name="coName" value="${cooper.coName }" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-2 col-sm-3 col-xs-12" for="lastDay">Last Day</label>
                        <div class="col-md-6 col-sm-6 col-xs-8">
                          <input type="date" id="lastDay" name="lastDay" value="${cooper.lastDay }" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="control-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-8" id="connForm">
                          <input id="tags" type="text" name="connChains" value="${cooper.connChains }" class="tags form-control" />
                        </div>
                      </div>
                      <div class="form-group"></div>
                      <div class="form-group">
                        <label class="control-label col-md-2 col-sm-3 col-xs-12">Cooper Banner </label>
                        <div class="col-md-6 col-sm-6 col-xs-8">
                          <input type="text" id="coBanner" name="coBanner" value="${cooper.coBanner }" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
