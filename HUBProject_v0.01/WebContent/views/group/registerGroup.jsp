   			...
   			<div class="modal-body">
				<form id="registerGroupForm" action="${pageContext.request.contextPath}/group/register.do" class="form-horizontal form-label-left groupForm" method="post" enctype="multipart/form-data">
					<div class="form-group">
						<label class="control-label col-md-2 col-sm-3 col-xs-12" for="groupName">모임방 이름 <span class="required">*</span></label>
					...
					<div class="form-group">
						<div>
							<label class="control-label col-md-2 col-sm-3 col-xs-12" for="managerId">개설자 <span class="required">*</span></label>
							<div class="col-md-6 col-sm-6 col-xs-8">
								<input type="text" id="managerId" name="managerId" required="required" class="form-control col-md-7 col-xs-12" value="${sessionScope.userId }" readonly>
							</div>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<div>
							<label class="control-label col-md-2 col-sm-3 col-xs-12" for="maxPeople">최대인원 <span class="required">*</span></label>
							<div class="col-md-6 col-sm-6 col-xs-8">
