            ...
            <div class="row">
              <div class="col-md-8 col-sm-12 col-xs-12 col-md-offset-2">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
					<form id="demo-form2" action="${pageContext.request.contextPath}/bucketlist/modify.do" data-parsley-validate class="form-horizontal form-label-left" method="post">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-8">
                          <input type="text" id="goal" name="goal" value="${bucketlist.goal }" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-2 col-sm-3 col-xs-12" for="star">Star <span><small>(10점 만점)</small></span></label>
                        <div class="col-md-2 col-sm-3 col-xs-3">
                          <input type="number" id="star" value="${bucketlist.star }" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-8" id="connForm">
                          <input id="tags" type="text" name="connChains" value="${bucketlist.connChains }" class="tags form-control" />
                        </div>
                      </div>
